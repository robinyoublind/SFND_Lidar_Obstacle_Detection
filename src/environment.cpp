...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr &viewer)
{
    ...
    pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud = pointProcessorI->FilterCloud(inputCloud, 0.1 , Eigen::Vector4f (-30, -5, -2, 1), Eigen::Vector4f ( 30, 5, 10, 1));

    std::cout << "filtered cloud is: " << ((inputCloud->width * inputCloud->height) / (filterCloud->width * filterCloud->height))*100 << " times smaller" << endl;
    ...
    renderPointCloud(viewer,segmentCloud.second,"road",Color(0,1,0));
    //renderPointCloud(viewer,segmentCloud.first,"cars",Color(1,1,1));
